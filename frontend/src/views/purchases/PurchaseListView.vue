        ...
        <table class="min-w-full divide-y divide-gray-300">
          ...
          <tbody class="divide-y divide-gray-200 bg-white">
            ...
            <tr v-for="inv in purchases" :key="inv.id" class="hover:bg-gray-50 transition-colors">
              ...
              <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ inv.party?.name || '—' }}</td>
              <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ formatDate(inv.date) }}</td>
              <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ formatDate(inv.due_date) }}</td>
