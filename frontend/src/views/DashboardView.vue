  ...
  <AppLayout>
    ...
    <div class="mb-4 flex items-center justify-between">
      <div>
        ...
        <p class="text-xs text-gray-400">Business overview</p>
      </div>
      <div class="relative">
        <button @click="showCreateDropdown = !showCreateDropdown"
          ...
          Create New
          <svg class="ml-1 h-4 w-4 transition-transform" :class="{'rotate-180': showCreateDropdown}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
      <!-- Sales Revenue -->
      <div
        class="bg-white rounded-xl border border-gray-100 p-3 flex items-start justify-between hover:shadow-sm transition-shadow">
        <div>
          <dt class="text-[11px] font-medium text-gray-400">Sales Revenue</dt>
          <dd class="mt-0.5 text-xl font-bold text-gray-900">₹{{ abbreviateNumber(metrics.revenue) }}</dd>
          <dd class="mt-0.5 text-[10px] text-green-600 font-medium bg-green-50 px-1.5 py-0.5 rounded-full inline-block">
            Received &amp; Pending</dd>
        </div>
      ...
      <div
        class="bg-white rounded-xl border border-gray-100 p-3 flex items-start justify-between hover:shadow-sm transition-shadow">
        <div>
          <dt class="text-[11px] font-medium text-gray-400">Outstanding</dt>
          <dd class="mt-0.5 text-xl font-bold text-gray-900">₹{{ abbreviateNumber(metrics.outstanding) }}</dd>
          <dd
            class="mt-0.5 text-[10px] text-orange-600 font-medium bg-orange-50 px-1.5 py-0.5 rounded-full inline-block">
            To be collected</dd>
        </div>
      ...
      <!-- Total Purchases -->
      <div
        class="bg-white rounded-xl border border-orange-50 p-3 flex items-start justify-between hover:shadow-sm transition-shadow">
        <div>
          <dt class="text-[11px] font-medium text-gray-400">Total Purchases</dt>
          <dd class="mt-0.5 text-xl font-bold text-gray-900">₹{{ abbreviateNumber(metrics.total_purchases) }}</dd>
          <dd
            class="mt-0.5 text-[10px] text-orange-600 font-medium bg-orange-50 px-1.5 py-0.5 rounded-full inline-block">
            Bills from vendors</dd>
        </div>
        <div class="p-2 bg-orange-50 rounded-lg text-orange-500 shrink-0">
          <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <!-- Payable to Vendors -->
      <div
        class="bg-white rounded-xl border border-red-50 p-3 flex items-start justify-between hover:shadow-sm transition-shadow">
        <div>
          <dt class="text-[11px] font-medium text-gray-400">Payable to Vendors</dt>
          <dd class="mt-0.5 text-xl font-bold text-gray-900">₹{{ abbreviateNumber(metrics.payable_to_vendors) }}</dd>
          <dd class="mt-0.5 text-[10px] text-red-600 font-medium bg-red-50 px-1.5 py-0.5 rounded-full inline-block">
            Pending payment</dd>
        </div>
        <div class="p-2 bg-red-50 rounded-lg text-red-500 shrink-0">
          <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
