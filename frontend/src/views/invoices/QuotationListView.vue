        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Manage your estimates and quotations.
                </p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        <tr v-else-if="invoices.length === 0">
                            <td colspan="6" class="text-center py-4 text-gray-500">No estimates found.</td>
                        </tr>
                        <tr v-for="invoice in invoices" :key="invoice.id">
                            <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                                <router-link :to="`/quotations/${invoice.id}`"
                            ...
                            <td
                                ...
                                <router-link :to="`/quotations/${invoice.id}/edit`" v-if="invoice.status === 'draft'"
...
const typeFilter = ref('quote') // Hardcoded for QuotationListView
