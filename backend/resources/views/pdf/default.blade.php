...
<body class="p-8">
        ...
        <tr>
            <td style="vertical-align: top;">
                ...
                <div style="overflow: hidden;">
                    ...
                    <div class="company-address">
                        {{ $business->address }}
                        @if ($business->gstin)
                            <div style="margin-top: 2px; color: #374151; font-weight: 500;">GSTIN:
                                {{ $business->gstin }}</div>
                        @endif
            ...
            <td class="text-right" style="vertical-align: top; width: 40%;">
                ...
                <div style="margin-top: 8px; font-size: 12px; color: #6b7280;">
                    <div>Date: <span class="font-medium text-gray-900">{{ $invoice->date->format('d M, Y') }}</span>
                    </div>
                    @if ($invoice->due_date)
                        <div>Due: <span
                                class="font-medium text-gray-900">{{ $invoice->due_date->format('d M, Y') }}</span>
                        </div>
                    @endif
                </div>
            </td>
                    ...
                    <div style="background-color: #f9fafb; padding: 12px; border-radius: 6px;">
                        ...
                        <table style="font-size: 12px;">
                            @if ($invoice->vehicle_no)
                                <tr>
                                    <td class="text-gray-500 w-half">Vehicle:</td>
                                    <td>{{ $invoice->vehicle_no }}</td>
                                </tr>
                            @endif
                            @if ($invoice->eway_bill_no)
                                <tr>
                                    <td class="text-gray-500 w-half">E-Way:</td>
                                    <td>{{ $invoice->eway_bill_no }}</td>
                                </tr>
                            @endif
                            @if ($invoice->po_number)
                                <tr>
                                    <td class="text-gray-500 w-half">PO No:</td>
        ...
        <tbody>
            @foreach ($invoice->items as $index => $item)
                <tr>
                    ...
                    @endif
                    <td class="text-right font-bold text-gray-900" style="padding-right: 8px;">
        ...
        <tr>
                    ...
                    <div style="margin-bottom: 24px;">
                        ...
                        <div style="display: inline-block; vertical-align: top;">
                            <table style="font-size: 12px; color: #4b5563;">
                                <tr>
                                    <td style="padding-right: 12px;">Bank:</td>
                                    <td class="font-bold text-gray-900">{{ $business->bank_name }}</td>
                                </tr>
                                <tr>
                                    <td>A/c:</td>
                                    <td class="font-bold text-gray-900">{{ $business->account_number }}</td>
                                </tr>
                                <tr>
                                    <td>IFSC:</td>
                                    <td class="font-bold text-gray-900">{{ $business->ifsc_code }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
            ...
            <td style="width: 45%; vertical-align: top;">
                ...
                <div style="margin-top: 40px; text-align: right;">
                    ...
                    <div class="text-xs text-gray-400 uppercase border-t border-gray-300 pt-2 inline-block">Authorized
                        Signatory</div>
                </div>
            </td>
        </tr>
    ...
    <div class="branding-footer">
        Powered directly by <span style="font-weight: bold; color: #111827;">VedantBilling</span>
    </div>
